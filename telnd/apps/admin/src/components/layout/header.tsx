  ...
  return (
    <header className="admin-header">
      <div className="admin-header-left">
        <button className="sidebar-toggle mobile-menu-btn" onClick={onToggleMobile} title="Menu">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
        </button>
        <button className="sidebar-toggle desktop-toggle" onClick={onToggleSidebar} title="Toggle sidebar">
          {collapsed ? (
        ...
        <Link href="/" className="admin-logo">TELND Admin</Link>
      </div>
