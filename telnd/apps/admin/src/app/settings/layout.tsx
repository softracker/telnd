...
const settingsNav = [
  {
    ...
    description: 'Application name, logo, and basic configuration',
    icon: (
  ...
  },
  {
    ...
    href: '/settings/login-providers',
    description: 'Configure OAuth, SSO, and social login options',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Configure Cloudflare Turnstile for bot protection',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    label: 'SMTP / Email',
    href: '/settings/smtp',
    description: 'Set up email server for notifications and alerts',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Manage office locations and working hours',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Company details, branding, and legal information',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Billing, invoices, and payment gateway settings',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'API gateway, rate limits, and access tokens',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    label: 'About',
    href: '/settings/about',
    description: 'Version info, licenses, and support links',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <>
      ...
      <div className="settings-layout" style={{ display: 'flex', height: '100%', position: 'relative' }}>
        ...
        {/* Toggle button — fixed position at the main sidebar edge */}
        <button
